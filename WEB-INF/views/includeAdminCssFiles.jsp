...
<%-- <link href="<%= request.getContextPath() %>/resources/bootstrap/jquery.dataTables.css" rel="stylesheet"> --%>
<link href="<%= request.getContextPath() %>/resources/jquery/jquery.loadmask.css" rel="stylesheet">
<%-- <link href="<%= request.getContextPath() %>/resources/bootstrap/dataTables.bootstrap.css" rel="stylesheet"> --%>
<link href="<%= request.getContextPath() %>/resources/css/main.css" rel="stylesheet">
<link href="<%= request.getContextPath() %>/resources/css/adminMain.css" rel="stylesheet">
