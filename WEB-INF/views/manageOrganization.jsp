...
<div id="loadMaskDiv" class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
	<div class="container">
		...
		<ul id="tabs" class="nav nav-tabs" data-tabs="tabs">
			<li class="active"><a href="" data-toggle="tab" onclick="addOrganization();">Add New Organization</a>
			</li>
			<li id="list"><a href="" data-toggle="tab" onclick="listOfManagedOrganization()">List Of Managed Organization</a>
			</li>
		</ul>
		<div id="my-tab-content" class="tab-content">
			...
			<form class="form-horizontal" role="form"  id="addOrganizationForm">
			   ...
			   <div class="form-group">
			      <label class="col-sm-2 control-label"><spring:message code="label.City"/></label>
			      <div class="col-sm-10">
			         <div id="cityList"></div>
			   </div>
			   </div>
			...
			<div class="tab-pane" id="listOfOrganizationData">
			</div>
		</div>
	</div>
	<div class="modal fade" id="editOrganizationModal"  style="margin-top: 120px;margin-left: 170px;">
		<div class="modal-dialog" style="width:900px;">
			<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
						<h4 class="modal-title" id="editOrganizationLabel">Edit Organization</h4>
					</div>
					<div class="modal-body" style="margin-left: 10px;" id="organizationDataBody">
					</div>
			</div>
		</div>
	</div>
