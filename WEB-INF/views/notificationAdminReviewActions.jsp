...
<title><spring:message code="label.notification.review.actions" /></title>
...
<!-- End Google Tag Manager (noscript) -->
 ...
 <div id="wrapper">
	...
	<div id="page-wrapper">
        ...
        <!-------------------------- Review Actions----------------------------------->
        <div class="row" id="adminReviewActions" style="display: none;">
     ...
     <!--    Paination -->
     <div id="paginationAdminReviewActionDiv"></div>
	</div>
</div>
	...
	<script src="<%=request.getContextPath()%>/resources/js/notificationAdminReviewActions.js"></script>
	<script>
