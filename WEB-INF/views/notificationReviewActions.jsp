...
<title>Notification Review Actions</title>
...
<body>
 ...
 <div id="wrapper">
	...
	<div id="page-wrapper">
		<div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Notification Review Actions</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        ...
        <!-------------------------- Review Actions----------------------------------->
        <div class="row" id="notificationReviewActions" style="display: none;">
	  ...
	  <div id="reviewActionsPaginationDiv"></div>   
	</div>
	
				<!--Success Message Modal-->
				<div class="modal fade"  tabindex="-1" role="dialog" id="notificationReviewNotificationsModal" aria-labelledby="" aria-hidden="true">
					<div class="modal-dialog modalSmallWidth">
						<div class="modal-content moduleSmall-content">
							<div class="modal-header">
								...
								<h4 class="modal-title" id="notificationReviewNotificationsModalTitle">Success</h4>
							</div>
							
							<div id="body2"   align="center" class="modal-body">
							 	<p id="notificationReviewNotificationsModalText" class="warning">Review broadcasted successfully !</p>
							 	<div class="row mt10">
...
<script
	...
	<script src="<%=request.getContextPath()%>/resources/js/notificationReviewActions.js"></script>
