...
<title>User Review Actions</title>
...
<!-- End Google Tag Manager (noscript) -->
 ...
 <div id="wrapper">
	...
	<div id="page-wrapper">
		<div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">User Review Actions</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <div class="row" id="reviewActionsBredcrumb">
                <div class="col-lg-12 SubHeading SmallDarkGreyHeader">
					...
					<span>User Review Actions</span>
                </div>
                <!-- /.col-lg-12 -->
            </div>
        <!-------------------------- Review Actions----------------------------------->
        <div class="row" id="userReviewActions" style="display: none;">
      ...
      <div id="reviewActionReachedDeadlineDiv"></div>
	</div>
	
		<!--Success Message Modal-->
				<div class="modal fade"  tabindex="-1" role="dialog" id="notificationReachedDeadlineReviewsSuccessModal" aria-labelledby="" aria-hidden="true">
					<div class="modal-dialog modalSmallWidth">
						<div class="modal-content moduleSmall-content">
							<div class="modal-header">
								...
								<h4 class="modal-title" id="notificationReachedDeadlineReviewsSuccessModalTitle">Success</h4>
							</div>
							
							<div id="body2"   align="center" class="modal-body">
							 	<p id="notificationReachedDeadlineReviewsSuccessModalText" class="warning">Review broadcasted successfully !</p>
							 	<div class="row mt10">
	...
	<script src="<%=request.getContextPath()%>/resources/js/notificationUserActionsReachedDeadline.js"></script>	 
	<script>
