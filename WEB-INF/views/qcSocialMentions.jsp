...
<meta name="author" content="Bishav.n.r">
 ...
 <title><spring:message code="label.qc.social.mentions" /></title>
...
<!-------------END of ORGANIZATION SELECTION & DATE PICKET----------------------------->
 ...
 <!-------------------------------------- END of MAIN NAVIGATION  ------------------------------------>
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Quality Control For Social Mentions</h1>
                </div>
            </div>
            <!-- <div class="row">
			...
			<!-------------------------- Mentions ----------------------------------->
			<div class="row" id="dashboardSocialMentions" style="display: none;">
					...
					<div class="col-xs-12 col-sm-3 col-lg-2 LightBlue ShowSemanticPolarity">
						<div class="reviewDetails row">
							...
							<div class="revieweTime"><span class="glyphicon glyphicon-time">
								</span><span> 12 September 2014</span>
							</div>
						</div>
					</div>
					<div class="col-xs-12 col-sm-9 col-lg-10">
						<h3 class="SingleReviewHeader">This is a Mention title</h3>
						<p>
...
<!------------------------------------------------------------------------------>	
 			 ...
 			 <!--Success Message Modal-->
				<div class="modal fade"  tabindex="-1" role="dialog" id="updateSuccessModal" aria-labelledby="" aria-hidden="true">
					<div class="modal-dialog modalSmallWidth">
						<div class="modal-content moduleSmall-content">
							<div class="modal-header">
								...
								<h4 class="modal-title" id="updateSuccessModalTitle">Success</h4>
							</div>
							
							<div id="body2"   align="center" class="modal-body">
							 	<p id="updateSuccessModalText" class="warning">Taged successfully !</p>
							 	<div class="row mt10">
	...
	<script src="<%=request.getContextPath()%>/resources/js/qcSocialMentions.js"></script>
