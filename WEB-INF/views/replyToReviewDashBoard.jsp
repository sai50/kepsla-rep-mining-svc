...
<body>
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">Reply To Review Dashboard</h1>
				</div>
					...
					<div class="panel-body">
						...
						<ul id="tabs" class="nav nav-tabs" data-tabs="tabs">
							<li class="active" style="float: left;"><a
								...
								onclick="organizationSourceMappingClick()">Reply To Review DashBoard</a></li>
						</ul>
...
<script src="${pageContext.request.contextPath}/resources/js/replyToReviewDashBoard.js"></script>
</html>