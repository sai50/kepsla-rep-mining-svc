...
<div id="loadMaskDiv" class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
	<!-- Fixed navbar -->
		<ul id="tabs" class="nav nav-tabs" data-tabs="tabs">
			<li class="active"><a href="#addUser" data-toggle="tab" onclick="addNewUser()""><spring:message code="label.add.user"/></a>
			</li>
			<li><a href="#listUsers" data-toggle="tab" onclick="listUsers()"><spring:message code="label.user.management"/></a>
			</li>
		</ul>
		...
		<hr>
			<form class="form-horizontal" id="addUserForm">
				...
				<div class="alert alert-success" style="display: none;margin-left:-13px;" id="addUserSuccessDiv">
			 ...
			 <!-- -------------------User Name-------------------------------------- -->
				<div class="form-group" id="Add-userName-Error">
					...
					<span style="color: #a94442" id="userName-Error" class="help-inline"></span>
					<input	type="text" class="form-control" id="userName" name="userName" placeholder="User Name" maxlength="50"> 
				</div>
		 	  <!-- -------------------First Name-------------------------------------- -->
				<div class="form-group" id="Add-userFirstName-Error">
					...
					<input	type="text" class="form-control" id="userFirstName" name="userFirstName" placeholder="First Name" maxlength="50"> 
				</div>
				<!-- -------------------Middle Name-------------------------------------- -->
				<div class="form-group" id="Add-userMiddleName-Error">
					...
					<input	type="text" class="form-control" id="userMiddleName" name="userMiddleName" placeholder="Middle Name" maxlength="50"> 
				</div>
				<!-- -------------------Last Name-------------------------------------- -->
				<div class="form-group" id="Add-userLastName-Error">
					...
					<input	type="text" class="form-control" id="userLastName" name="userLastName" placeholder="Last Name" maxlength="50"> 
				</div>
				<!-- -------------------Primary Email-Id-------------------------------------- -->
				<div class="form-group" id="Add-primaryEmail-Error">
					...
					<input	type="text" class="form-control" id="primaryEmail" name="primaryEmail" placeholder="Primary Email-id" maxlength="50"> 
				</div>
				...
				<div class="form-group" id="Add-confirmPrimaryEmailId-Error">
					...
					<input	type="text" class="form-control" id="confirmPrimaryEmailId" name="primaryEmailId" placeholder="Primary Email-id" maxlength="50"> 
				</div>
				<!-- -------------------Password-------------------------------------- -->
				...
				<div class="form-group" id="Add-confirmPassword-Error">
					...
					<input	type="password" class="form-control" id="confirmPassword" name="ConfirmPassWord" placeholder="Confirm PassWord" maxlength="50"> 
				</div>
				<!-- -------------------Secondary Email-Id-------------------------------------- -->
				<div class="form-group" id="Add-secondaryEmail-Error">
					...
					<input	type="text" class="form-control" id="secondaryEmail" name="secondaryEmail" placeholder="Secondary Email-id" maxlength="50"> 
				</div>
				<!-- -------------------Mobile Number-------------------------------------- -->
				<div class="form-group" id="Add-mobile-Error">
					...
					<input	type="text" class="form-control" id="mobile" name="mobile" placeholder="Mobile Number" maxlength="50"> 
				</div>
				<!-- -------------------Phone Number------------------------------------- -->
				<div class="form-group" id="Add-phone-Error">
					...
					<input	type="text" class="form-control" id="phone" name="phone" placeholder="Phone Number" maxlength="50"> 
				</div>
				<!-- -------------------Fax------------------------------------- -->
				<div class="form-group" id="Add-fax-Error">
					...
					<input	type="text" class="form-control" id="fax" name="fax" placeholder="Fax" maxlength="50"> 
				</div>
			<!--------------------- Button --------------------------------------------->
			<c:choose>
				<c:when test="${ROLES_EMPTY eq 'TRUE' }">
