...
var keywordInnerPageUrl = "../keywordInnerPage/";
var keywordInnerPageStartPage= 0;
var keywordInnerPageEndPage = 10;
var keywordInnerPage = 1;
...
function filterKeywordInnerPage(){
	...
	window.location.href = "../keywordInnerPage/page.htm?kpiId="+kpiId+"&departmentId="+departmentId+"&keywordId="+keywordId+"&isBreadCrumb="+isBreadCrumb+"&organizationId="+organizationId+"&fromDate="+fromDate+"&toDate="+toDate;
...
function keywordInnerPageChart(){
	...
	$.ajax({
		type:"POST",
		url:keywordInnerPageUrl+"innerChart.htm",
...
function listKeywordInnerPageReviews(organizationId){
	...
	$.ajax({
		type:"POST",
		url:"../keywordInnerPage/showReviewsForKeywords.htm",
		contentType:"application/json",
